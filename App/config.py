...
def load_config():
    ...
    if config['ENV'] == "DEVELOPMENT":
        from .custom_config import JWT_ACCESS_TOKEN_EXPIRES, SQLALCHEMY_DATABASE_URI, SECRET_KEY, NINJA_TOKEN, EXERCISE_TOKEN
        config['SQLALCHEMY_DATABASE_URI'] = SQLALCHEMY_DATABASE_URI
        config['SECRET_KEY'] = SECRET_KEY
        config['NINJA_TOKEN'] = NINJA_TOKEN
        config['EXERCISE_TOKEN'] = EXERCISE_TOKEN
        ...
        config['EXERCISE_TOKEN'] = os.environ.get('EXERCISE_TOKEN')
